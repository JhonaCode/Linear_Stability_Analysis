...
from   source_lst.Eigenvalues      import * 

from types import SimpleNamespace


#def configurar_variables(**kwargs):
#
#    path    = kwargs.get('path')
#    file1   = kwargs.get('file1')
#    file1   = kwargs.get('file2')
def define_analysis(D,D2,Wb,d2Wbdr,**kwargs):
    ...
    if (analysis=='spatial'):                    
        ...
        alphar1,alphai1= spatial(D,D2,Wb,d2Wbdr,omega,**kwargs)
...
def temporal(D,D2,Wb,d2Wbdr,alpha,**kwargs): 
    ...
    for ialpha in alpha: 
        ...
        omegar,omegai,neig= eigenvalues_f(A0,B0,DD,N,kmin_imag,max_imag,min_real,max_real)
...
def spatial(D,D2,Wb,d2Wbdr,omega,**kwargs): 
